    ...
    <body>
        ...
        <div class="copyright text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div>by wina | winawsari@gmail.com</a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="feature-2">
                                <div class="media">
                                    <i class="fa fa-angellist pull-left"></i>
                                    <div class="media-body">                                        
                                        <table class="table-hover table table-striped">
                                            <tr>
                                                <td>No</td>
                                            ...
                                            include 'koneksi.php';
                                            $i = 0;
                                            $tampil = "SELECT * FROM anggota ORDER BY id DESC";
                                            $sql = mysql_query($tampil);
                                            //print($tampil);
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title text-center">
                        ...
                        <p>Perpustakaan SMK Terpadu Al-Ikhwan</p>
                    </div>
                </div>
                <div class="row">
